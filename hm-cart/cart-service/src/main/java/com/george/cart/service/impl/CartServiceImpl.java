package com.george.cart.service.impl;
...
import com.george.cart.mapper.CartMapper;
import com.george.cart.properties.CartProperties;
import com.george.cart.service.ICartService;
import com.george.itemapi.client.ItemClient;
...
/*        // 1.获取商品id
        ...
        // 2.查询商品
        List<ServiceInstance> instances = discoveryClient.getInstances("hm-item");
        ServiceInstance serviceInstance = instances.get(RandomUtil.randomInt(instances.size()));
        DURI uri = serviceInstance.getUri();
